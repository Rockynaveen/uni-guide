...
export default function ContactUsPage({ onBackToHome }: ContactUsPageProps) {
  ...
  const branchOffices = [
    ...
    },
    {
      ...
      phone: "+91 90007 57786, +91 99595 71900",
      email: "Hyd@uni-guide.co.uk",
    ...
    },
    {
      ...
      phone: "+91 99894 85862, +91 95531 03125",
      email: "mumbai@uni-guide.co.uk",
      hours: "Mon - Sat: 10 AM - 7 PM IST",
    },
    {
      id: "delhi",
      ...
      phone: "+91 89198 70728, +91 99123 28770",
      email: "delhi@uni-guide.co.uk",
      hours: "Mon - Sat: 10 AM - 7 PM IST",
    },
    {
      id: "melbourne",
      ...
      phone: "+61 433 721 957, +61 426 040 786",
      email: "aus@uni-guide.co.uk",
