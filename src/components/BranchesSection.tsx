  ...
  const branches = [
    {
      ...
      phones: ["07979797734"],
      emails: ["info@uniguide.co.uk"],
      website: "www.uniguide.co.uk",
      highlight: "Exactly building behind the bus stop - Unit 3, 3rd floor",
    ...
    },
    {
      ...
      country: "India",
      address: "Himayath Nagar Main Road, Near Malabar Gold Showroom, Opp Maruti Suzuki Car Showroom, GS Tower, Suite 203 2nd Floor & 303 3rd Floor, Hyderabad, Telangana 500029, India",
      phones: ["+91 90007 57786", "+91 99595 71900"],
      emails: ["admin@guideoverseas.com"],
    ...
    },
    {
      ...
      phones: ["+91 99894 85862", "+91 95531 03125"],
      emails: ["mumbai@guideoverseas.com"],
    ...
    },
    {
      ...
      phones: ["+91 89198 70728", "+91 99123 28770"],
      emails: ["delhi@guideoverseas.com"],
    ...
    },
    {
      ...
      country: "Australia",
      address: "6 Faraday Court, Truganina, Victoria, Melbourne 3029, Australia",
      phones: ["+61 433 721 957", "+61 426 040 786"],
      emails: ["aus@guideoverseas.com"],
